...
##    This file is pam_mhcrfid 0.1.3
##
...
openlog("[pam_mhcrfid]", LOG_PID, LOG_AUTH);
	...
	//check if lasttag file exist to avid errors
	if (fp1==NULL)
	{
	syslog(LOG_WARNING,"unable to open lasttag file");
	closelog();
	return (PAM_SERVICE_ERR);
	}
